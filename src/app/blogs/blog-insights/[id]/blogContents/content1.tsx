  ...
  return (
    <div className="bg-gray-100 text-gray-900 py-8 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        {/* Algorithmic Bias */}
        <h2 className="text-xl font-bold text-gray-800 mb-4">Algorithmic Bias</h2>
        <p className="text-base leading-relaxed text-gray-700 mb-4">
        ...
        <h2 className="text-xl font-bold text-gray-800 mb-4">Accountability and Transparency</h2>
        <p className="text-base leading-relaxed text-gray-700 mb-4">
        ...
        <h2 className="text-xl font-bold text-gray-800 mb-4">Ethical AI Governance</h2>
        <p className="text-base leading-relaxed text-gray-700 mb-4">
        ...
        <h2 className="text-xl font-bold text-gray-800 mb-4">The Role of Developers</h2>
        <p className="text-base leading-relaxed text-gray-700 mb-4">
