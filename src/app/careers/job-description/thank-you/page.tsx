...
const ThankYou: React.FC = () => {
  ...
  useEffect(() => {
    if (countdown === 0) {
      router.push("/careers"); // Redirect to the Career page when countdown reaches 0
    }
  }, [countdown, router]);
    ...
    <div className="bg-gray-50 text-gray-900">
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-blue-100 via-white to-blue-100 text-center">
        ...
        <p className="text-lg text-gray-700 max-w-3xl mx-auto mt-4">
          Your application has been successfully sent. We will get back to you as soon as possible.
        </p>
        <p className="mt-4 text-sm text-gray-500">
            Redirecting to the Career page in <span className="font-bold">{countdown}</span> seconds...
          </p>
      </section>
