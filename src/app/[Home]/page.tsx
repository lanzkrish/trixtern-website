...
function Home() {
  ...
  return (
    <div className="bg-gray-200 text-gray-900 min-h-screen dark:bg-gray-900 dark:text-gray-100">
      ...
      {/* Hero Section */}
      <section className="relative min-h-screen flex flex-col items-center justify-center text-center overflow-hidden p-6 sm:p-10 md:p-16  bg-gradient-to-br from-gray-200  via-white to-white ">
      ...
      {/* Who We Are */}
      <section className="hero-section min-h-screen flex flex-col items-center justify-center p-6 sm:p-10 md:p-16 bg-gray-950">
      ...
      {/* Core Values */}
      <section className="hero-section min-h-screen flex flex-col items-center justify-center p-6 sm:p-10 md:p-16 bg-gradient-to-br from-gray-200  via-white to-gray-200  ">
      ...
      {/* Call to Action */}
      <section className="hero-section max-h-100 flex flex-col items-center justify-center p-6 sm:p-10 md:p-16 bg-gradient-to-br from-gray-200  via-white to-gray-200">
